                    ...
                    <div class="card">
                        <header class="card-header">
                            <p class="card-header-title">
                                <a class="{{ $site->is_down ? 'has-text-danger' : '' }}" target="_blank" href="{{$site->url}}">
                                    @if($site->is_secure)
                        ...
                        <div class="card-content">
                            ...
                            @else
                                <div class="content">
                                    <p>
                                        Last Down: {{ $site->last_down ? $site->last_down->deleted_at->diffForHumans() : 'never' }}<br>
                                        @if($site->last_down)
                                            Reason: {{ $site->last_down->reason }}
                                        @endif
                                    </p>
                        ...
                        <footer class="card-footer">
                            <a href="{{route('site.show', $site->id)}}" class="card-footer-item">View</a>
